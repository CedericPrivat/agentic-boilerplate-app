...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: Field is a generic grouping component, not always a fieldset
    <div
      role="group"
      data-slot="field"
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map((error, index) =>
          error?.message ? (
            // biome-ignore lint/suspicious/noArrayIndexKey: error messages have no stable key
